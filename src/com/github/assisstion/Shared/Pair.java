package com.github.assisstion.Shared;
...
public class Pair<T, S> implements Serializable{
	...
	public String toString(){
		String valueOneString = getValueOne() == null ? "null" : getValueOne()
				.toString();
		String valueTwoString = getValueTwo() == null ? "null" : getValueTwo()
				.toString();
	...
	public boolean equals(Object o){
		if(o instanceof Pair){
			Pair<?, ?> p = (Pair<?, ?>) o;
			if(getValueOne().equals(p.getValueOne()) &&
					getValueTwo().equals(p.getValueTwo())){
				return true;
			}
		}
		return false;
	...
	@Override
	public int hashCode(){
		return getValueOne().hashCode() ^ getValueTwo().hashCode(); // << 8 ^
																	// HIGH_MASK
																	// ^
																	// getValueTwo().hashCode()
																	// >> 8 ^
																	// LOW_MASK;
	}
}
